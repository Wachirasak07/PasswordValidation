...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("pw len =20 ", PasswordValidator.validate("aA3456789fkgotidlvot")==true);
        check("pw len >20 ", PasswordValidator.validate("aA3456789fkgotidlvots")==false);
        ...
        // TODO: boundary อื่นๆ ที่คุณคิดว่าจำเป็น
         check("pw Other ", PasswordValidator.validate("..")==false);
         check("pw Other ", PasswordValidator.validate("aA1$$$$$")==true);
